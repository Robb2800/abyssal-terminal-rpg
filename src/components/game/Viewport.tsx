...
export function Viewport() {
  ...
  return (
    <div className="h-[60%] w-full flex flex-col border-b-2 border-[#39ff14]/50 relative overflow-hidden bg-[#050505]">
      {/* HUD Bar */}
      <div className="flex justify-between items-center px-6 py-4 border-b border-[#39ff14]/20 text-sm md:text-base font-bold tracking-widest">
        <div className="flex gap-4 items-center">
          <span>HP:</span>
          <div className="w-48 h-3 border border-[#39ff14] p-0.5">
            <div 
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        {currentEncounter && (
          <div className="mt-8 text-center space-y-1">
            ...
            <div className="text-sm opacity-80">HP: {currentEncounter.hp} / {currentEncounter.maxHp}</div>
